...
1. **The submission deadline is 04.12.2019, 23:59:59**. Your homework should be submitted to `dse2019hsehw3@gmail.com`. **No late submissions will be accepted**;
...
# Problem 1: Multinomial Logit (40 points)

In this question you (once again) learn what is a logit model and how to estimate it via maximum likelihood.
